"""
Django settings for pqapp_45123 project.
...
WSGI_APPLICATION = 'pqapp_45123.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pqapp_45123 API",
    "DESCRIPTION": "API documentation for pqapp_45123 App",
    "VERSION": "v1",
}
